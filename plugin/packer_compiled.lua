...
_G.packer_plugins = {
  ["copilot.vim"] = {
    loaded = true,
    path = "/Users/roadup/.local/share/nvim/site/pack/packer/start/copilot.vim",
...
pcall(vim.cmd, [[command -nargs=* -range -bang -complete=file CodeAction lua require("packer.load")({'nvim-code-action-menu'}, { cmd = "CodeAction", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args>, mods = "<mods>" }, _G.packer_plugins)]])
